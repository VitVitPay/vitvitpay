...
"plugins": [
    [
        "react-native-auth0",
        {
            "domain": "dev-ez4dxeheiyk7fb0v.us.auth0.com"
...
Replace `dev-ez4dxeheiyk7fb0v.us.auth0.com` with your Auth0 domain value. If you have `samples.auth0.com` as your Auth0 domain you would have a configuration like the following:
